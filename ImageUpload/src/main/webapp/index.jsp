...
<head>
    ...
    <title>santhosh|Login & Registration</title>
</head>
<body>
   <div class="wrapper">
    <nav class="nav">
    ...
    <div class="form-box">
        ...
        <form action="UserLogin" method="post">
            ...
            <div class="input-box">
                <input type="date" class="input-field" name="dob" placeholder="Date ">
        ...
        <form action="UserSignup" method="post">
            ...
            <div class="input-box">
                <input type="date" class="input-field" name="dob" required placeholder="date">
                <i class="bx bx-lock-alt"></i>
            </div>
            <div class="input-box">
